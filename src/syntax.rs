    ...
    pub static ref HLDB: Vec<Syntax> = vec![
        ...
        Syntax::new(
            ...
            vec![
                ...
                Keyword::Base("continue".into()),
                Keyword::Base("match".into()),
                Keyword::Type("struct".into()),
                Keyword::BuiltinVar("stdin".into()),
                Keyword::BuiltinVar("stdout".into()),
                Keyword::BuiltinVar("stderr".into()),
                Keyword::BuiltinVar("argv".into()),
                Keyword::BuiltinFn("len".into()),
                Keyword::BuiltinFn("len".into()),
                Keyword::BuiltinFn("puts".into()),
                Keyword::BuiltinFn("first".into()),
                Keyword::BuiltinFn("last".into()),
                Keyword::BuiltinFn("rest".into()),
                Keyword::BuiltinFn("push".into()),
                Keyword::BuiltinFn("pop".into()),
                Keyword::BuiltinFn("get".into()),
                Keyword::BuiltinFn("contains".into()),
                Keyword::BuiltinFn("insert".into()),
                Keyword::BuiltinFn("str".into()),
                Keyword::BuiltinFn("int".into()),
                Keyword::BuiltinFn("float".into()),
                Keyword::BuiltinFn("char".into()),
                Keyword::BuiltinFn("byte".into()),
                Keyword::BuiltinFn("time".into()),
                Keyword::BuiltinFn("exit".into()),
                Keyword::BuiltinFn("flush".into()),
                Keyword::BuiltinFn("format".into()),
                Keyword::BuiltinFn("print".into()),
                Keyword::BuiltinFn("println".into()),
                Keyword::BuiltinFn("eprint".into()),
                Keyword::BuiltinFn("eprintln".into()),
                Keyword::BuiltinFn("round".into()),
                Keyword::BuiltinFn("sleep".into()),
                Keyword::BuiltinFn("tolower".into()),
                Keyword::BuiltinFn("toupper".into()),
                Keyword::BuiltinFn("open".into()),
                Keyword::BuiltinFn("read".into()),
                Keyword::BuiltinFn("write".into()),
                Keyword::BuiltinFn("read_to_string".into()),
                Keyword::BuiltinFn("decode_utf8".into()),
                Keyword::BuiltinFn("encode_utf8".into()),
                Keyword::BuiltinFn("read_line".into()),
                Keyword::BuiltinFn("input".into()),
                Keyword::BuiltinFn("get_errno".into()),
                Keyword::BuiltinFn("strerror".into()),
                Keyword::BuiltinFn("is_error".into()),
                Keyword::BuiltinFn("sort".into()),
                Keyword::BuiltinFn("chars".into()),
                Keyword::BuiltinFn("join".into()),
                Keyword::BuiltinFn("rand".into()),
                Keyword::BuiltinFn("pcap_open".into()),
                Keyword::BuiltinFn("pcap_stream".into()),
                Keyword::BuiltinFn("pcap_read_next".into()),
                Keyword::BuiltinFn("pcap_read_all".into()),
                Keyword::BuiltinFn("pcap_write".into()),
            ],
        ),
    ];
}
